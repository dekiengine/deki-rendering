...
This package's types live in `DekiRendering`. Scene files store the qualified
name, so a component is `DekiRendering::SomeComponent` there, and code naming one
needs the namespace:
